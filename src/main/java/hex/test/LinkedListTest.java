...
public class LinkedListTest {
    ...
    public void testSizeWhenSizeIs0()  {
        final LinkedListHex<Integer> testInstance = new LinkedListHex<>();
    ...
    public void testContainsOnNull() {
        final LinkedListHex<Object> testInstance = new LinkedListHex<>();
        testInstance.add(1);
    ...
    public void testRemoveFirstIndex()  {
        final LinkedListHex<String> testInstance = new LinkedListHex<>();
        testInstance.add("a");
        testInstance.add("b");
        testInstance.add("c");
    ...
    public void testContainsAll() {
        final LinkedListHex<Integer> testInstance = new LinkedListHex<>();
        final LinkedListHex<Integer> testInstance2 = new LinkedListHex<>();
        testInstance.add(1);
        testInstance.add(2);
    ...
    public void testGetInListOnException() {
        final List<Object> testInstance = new LinkedListHex<>();
        testInstance.add(1);
        testInstance.add(2);
        testInstance.add("trololo");
    ...
    public void testHasPreviousWhenIteratorAtTheBeginningOfTheCollection() {
        ...
        assertFalse("The hasPrevious() method must return false when the" +
                " iterator is on the first LinkedListHex element.",listIterator.hasPrevious());
    }
    ...
    public void testNextIndex() {
        final LinkedListHex<String> testInstance = new LinkedListHex<String>(){
            {
                add("a");
                add("b");
                add("c");
    ...
    public void testNextIndexInEmptyList() {
        final LinkedListHex testInstance = new LinkedListHex<>();
    ...
    public void testRemoveTwoTimeInTheRow() {
        final Collection<Integer> testInstance = new LinkedListHex<>();
        testInstance.add(1);
        testInstance.add(2);
